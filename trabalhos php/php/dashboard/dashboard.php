				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="images/ion/user-people.png" width="20" alt=""/>
							<div class="header-info ms-3">
								<span class="font-w600 ">Olá, <b> <?php echo htmlspecialchars($_SESSION['username']); ?> </b>!</span> <!-- protege os caracteres e escreve o que está no campo username salvo na sessão -->
								<small class="text-end font-w400">Seja bem vindo!</small>
							</div>
						</a>
                    ...
                    <li><a href="produto.php">
							...
							<span class="nav-text">Adicionar produto</span>
						</a>
                    </li>
                    <li><a href="alterar-produto.php">
						<i class="flaticon-050-info"></i>
							<span class="nav-text">Atualizar produto</span>
						</a>
                    </li>
                    <li><a href="excluir-produto.php">
							<i class="flaticon-041-graph"></i>
							<span class="nav-text">Excluir produto</span>
						</a>
                    </li>
				...
				<div class="row">
					...
					<div class="col-xl-3 col-xxl-7">
						<div class="card">
							...
							<div class="card-body">	
								<div class="user-bx">
									<img src="images/ion/user-people.png" alt="">
									<div>
										<h6 class="user-name">Ravi</h6>
										<span class="meta">@ravitos666</span>
									</div>
								...
								<ul class="user-list">
									<li><img src="images/ion/user-people-2.png" alt=""></li>
									<li><img src="images/ion/hacker.png" alt=""></li>
									<li><img src="images/ion/user-people-3.png" alt=""></li>
									<li><img src="images/ion/user-people-4.png" alt=""></li>
